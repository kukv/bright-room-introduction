  ...
  [179],
  {
    ...
    './src lazy recursive ^\\.\\/.*$ include: (?:\\/src(?:\\/(?%21\\.)(?:(?:(?%21(?:^%7C\\/)\\.).)*?)\\/%7C\\/%7C$)(?%21\\.)(?=.)[^/]*?\\.stories\\.(js%7Cjsx%7Cmjs%7Cts%7Ctsx))$':
      (module, __unused_webpack_exports, __webpack_require__) => {
        var map = {
          './components/organisms/Footer/CopyLight.stories': [
            './src/components/organisms/Footer/CopyLight.stories.ts',
            803,
          ],
          './components/organisms/Footer/CopyLight.stories.ts': [
            './src/components/organisms/Footer/CopyLight.stories.ts',
            803,
          ],
          './components/organisms/social/X.stories': [
            './src/components/organisms/social/X.stories.ts',
            391,
            984,
          ],
          './components/organisms/social/X.stories.ts': [
            './src/components/organisms/social/X.stories.ts',
            391,
            984,
          ],
